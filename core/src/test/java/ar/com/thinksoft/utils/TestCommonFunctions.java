...
@Category(Dto.class)
public class TestCommonFunctions extends TestCase {

	private static final String clase = "ar.com.thinksoft.utils.TestCommonFunctions";

	String error = null;
	private String testName = null;

	public TestCommonFunctions( String testName )  {
		super( testName );
	}
	...
	public static Test suite() {
		return new TestSuite( TestCommonFunctions.class );
	}

	public void testCommonFunctions1() {
		...
		try {
			try {
				new ar.com.thinksoft.utils.CommonFunctions();
	...
	protected void tearDown() throws Exception {
		...
		CustomTest a = TestCommonFunctions.class.getMethod(testName).getAnnotation(CustomTest.class);
