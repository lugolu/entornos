...
public class TestServidor extends TestCase {
	...
	private static final String clase = "ar.com.thinksoft.business.dtosPersistance.entornos.TestServidor";
	...
	public void testInsert() {
		...
		try {
			...
			try {
				...
				ar.com.thinksoft.dtos.entornos.Servidor objeto = ar.com.thinksoft.dtos.entornos.Servidor.defaultBuilder();
	...
	public void testSelectEqualOne() {
		...
		try {
			StatelessSession session = null;
			List<ar.com.thinksoft.dtos.entornos.Servidor> list = null;
			try {
				session = CommonsTest.getSession();
