...
public class TestAplicacion extends TestCase {
	...
	private static final String clase = "ar.com.thinksoft.business.dtosPersistance.entornos.TestAplicacion";
	...
	public void testInsert() {
		...
		try {
			...
			try {
				...
				ar.com.thinksoft.dtos.entornos.Aplicacion objeto = ar.com.thinksoft.dtos.entornos.Aplicacion.defaultBuilder();
				PersistanceFactory.getIntDomain().insert(objeto, session, getClass());
				assertNotNull(objeto.getAplicacion());
	...
	public void testUpdate() {
		...
		try {
			List<ar.com.thinksoft.dtos.entornos.Aplicacion> list = null;
			StatelessSession session = null;
			Transaction t = null;
			try {
				session = CommonsTest.getSession();
