...
public class TestContenedor extends TestCase {
	...
	private static final String clase = "ar.com.thinksoft.business.dtosPersistance.entornos.TestContenedor";
	...
	public void testInsert() {
		...
		try {
			...
			try {
				...
				ar.com.thinksoft.dtos.entornos.Contenedor objeto = ar.com.thinksoft.dtos.entornos.Contenedor.defaultBuilder();
