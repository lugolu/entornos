...
public class TestAplicacionCliente extends TestCase {
	...
	private static final String clase = "ar.com.thinksoft.business.dtosPersistance.entornos.TestAplicacionCliente";
	...
	public void testInsert() {
		...
		try {
			...
			try {
				...
				ar.com.thinksoft.dtos.entornos.AplicacionCliente objeto = ar.com.thinksoft.dtos.entornos.AplicacionCliente.defaultBuilder();
	...
	public void testSelectEqualOne() {
		...
		try {
			StatelessSession session = null;
			List<ar.com.thinksoft.dtos.entornos.AplicacionCliente> list = null;
			try {
				session = CommonsTest.getSession();
