...
public class TestEntornoCliente extends TestCase {
	...
	private static final String clase = "ar.com.thinksoft.business.dtosPersistance.entornos.TestEntornoCliente";
	...
	public void testInsert() {
		...
		try {
			...
			try {
				...
				ar.com.thinksoft.dtos.entornos.EntornoCliente objeto = ar.com.thinksoft.dtos.entornos.EntornoCliente.defaultBuilder();
	...
	public void testSelectEqualOne() {
		...
		try {
			StatelessSession session = null;
			List<ar.com.thinksoft.dtos.entornos.EntornoCliente> list = null;
			try {
				session = CommonsTest.getSession();
