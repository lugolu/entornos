...
public class ParameterizedTestSuite extends TestSuite {
	...
	public ParameterizedTestSuite(
		...
		if (constructors.length != 1) {
			addTest(warning(testCaseClass.getName() + " must have a single public constructor."));
			return;
		}
	...
	private Collection<String> getTestMethods(final Class<? extends TestCase> testCaseClass) {
	...
	private void addConstructionException(Exception e) {
		addTest(warning("Instantiation of a testCase failed " + e.getClass().getName() + " " + e.getMessage()));
	}
