...
public class Commons {
	...
	private static boolean ignoreKern = true;
	private static boolean ignoreNextlab = true;
	private static boolean ignoreCalcValor = true;
	...
	public static boolean ignoreKern() {
		return ignoreKern;
	}

	public static boolean ignoreNextlab() {
		return ignoreNextlab;
	}

	public static boolean isIgnoreCalcValor() {
		return ignoreCalcValor;
	}
