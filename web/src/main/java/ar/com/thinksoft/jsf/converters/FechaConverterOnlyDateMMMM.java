...
@FacesConverter("fechaConverterOnlyDateMMMM")
public class FechaConverterOnlyDateMMMM implements Converter {
	...
	public Object getAsObject(FacesContext context, UIComponent component, String value) {
		...
		try {
			...
			// Analizo el a\u00f3o para ver si se ingres\u00f3 en 2 digitos
			if (anio.length() == 2) {
				int anioParte2 = Integer.valueOf(anio);

				int anioActual = Integer.valueOf(sdf.format(new Date()).substring(6, 10));
				// completo los dos 1ros digitos segun el a\u00f3o ingresado,
				// redondeando los valores al siglo mas pr\u00f3ximo
	...
	public String getAsString(FacesContext context, UIComponent component, Object value) {
		SimpleDateFormat sdf = new SimpleDateFormat("dd 'de' MMMM 'de' yyyy", new Locale("es", "AR"));
