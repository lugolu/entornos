...
ALTER TABLE ENTORNOS.ENTORNO_CLIENTE DROP CONSTRAINT R_1_ENTORNO_CLIENTE;

ALTER TABLE ENTORNOS.SERVIDOR DROP CONSTRAINT R_1_SERVIDOR;

ALTER TABLE eNTORNOS.CONTENEDOR DROP CONSTRAINT R_1_CONTENEDOR;

ALTER TABLE ENTORNOS.APLICACION_CLIENTE DROP CONSTRAINT R_1_APLICACION_CLIENTE;

ALTER TABLE ENTORNOS.APLICACION_CLIENTE DROP CONSTRAINT R_2_APLICACION_CLIENTE;

ALTER TABLE ENTORNOS.APLICACION_CLIENTE DROP CONSTRAINT R_3_APLICACION_CLIENTE;

ALTER TABLE ENTORNOS.DEPENDENCIA_APLICACION DROP CONSTRAINT R_1_DEPENDENCIA_APLICACION;

ALTER TABLE ENTORNOS.DEPENDENCIA_APLICACION DROP CONSTRAINT R_2_DEPENDENCIA_APLICACION;
