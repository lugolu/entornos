...
ALTER TABLE ENTORNOS.ENTORNO_CLIENTE ADD CONSTRAINT R_1_ENTORNO_CLIENTE 
    FOREIGN KEY (ID_CLIENTE) REFERENCES ENTORNOS.CLIENTE (ID_CLIENTE);

ALTER TABLE ENTORNOS.SERVIDOR ADD CONSTRAINT R_1_SERVIDOR 
    FOREIGN KEY (ID_CLIENTE) REFERENCES ENTORNOS.CLIENTE (ID_CLIENTE);

ALTER TABLE eNTORNOS.CONTENEDOR ADD CONSTRAINT R_1_CONTENEDOR 
    FOREIGN KEY (ID_CLIENTE, ID_SERVIDOR) REFERENCES ENTORNOS.SERVIDOR (ID_CLIENTE,ID_SERVIDOR);

ALTER TABLE ENTORNOS.APLICACION_CLIENTE ADD CONSTRAINT R_1_APLICACION_CLIENTE 
    FOREIGN KEY (ID_CLIENTE, ID_SERVIDOR, CONTENEDOR) REFERENCES eNTORNOS.CONTENEDOR (ID_CLIENTE,ID_SERVIDOR,CONTENEDOR);

ALTER TABLE ENTORNOS.APLICACION_CLIENTE ADD CONSTRAINT R_2_APLICACION_CLIENTE 
    FOREIGN KEY (APLICACION) REFERENCES ENTORNOS.APLICACION (APLICACION);

ALTER TABLE ENTORNOS.APLICACION_CLIENTE ADD CONSTRAINT R_3_APLICACION_CLIENTE 
    FOREIGN KEY (ID_CLIENTE, ID_ENTORNO) REFERENCES ENTORNOS.ENTORNO_CLIENTE (ID_CLIENTE,ID_ENTORNO);

ALTER TABLE ENTORNOS.DEPENDENCIA_APLICACION ADD CONSTRAINT R_1_DEPENDENCIA_APLICACION 
    FOREIGN KEY (ID_APLICACION_CLIENTE) REFERENCES ENTORNOS.APLICACION_CLIENTE (ID_APLICACION_CLIENTE);

ALTER TABLE ENTORNOS.DEPENDENCIA_APLICACION ADD CONSTRAINT R_2_DEPENDENCIA_APLICACION 
